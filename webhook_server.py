"""
DCL Webhook Server v2.1.0 — x402 Micropayments + Extended Metadata Audit
Deterministic AI audit layer. Tamper-evident. Metadata-only.

All core logic (chain, policies, detectors, seal formatting) now lives in
dcl_core.py and is imported here — this file is transport/payment plumbing
only, so webhook_server.py and mcp_server.py can never drift apart again.
"""
import os
import time
import uuid
